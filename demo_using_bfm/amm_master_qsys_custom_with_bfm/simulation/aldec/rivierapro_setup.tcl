...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"  -work custom_module_0_avalon_slave_translator
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work mm_master_bfm_0_m0_translator          
  vlog  "$QSYS_SIMDIR/submodules/custom_master_slave.sv"             -work custom_module_0                        
  vlog  "$QSYS_SIMDIR/submodules/verbosity_pkg.sv"                   -work mm_slave_bfm_0                         
  vlog  "$QSYS_SIMDIR/submodules/avalon_mm_pkg.sv"                   -work mm_slave_bfm_0                         
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm.sv"      -work mm_slave_bfm_0                         
  vlog  "$QSYS_SIMDIR/submodules/verbosity_pkg.sv"                   -work mm_master_bfm_0                        
  vlog  "$QSYS_SIMDIR/submodules/avalon_mm_pkg.sv"                   -work mm_master_bfm_0                        
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_mm_master_bfm.sv"     -work mm_master_bfm_0                        
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L rst_controller -L custom_module_0_avalon_slave_translator -L mm_master_bfm_0_m0_translator -L custom_module_0 -L mm_slave_bfm_0 -L mm_master_bfm_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L rst_controller -L custom_module_0_avalon_slave_translator -L mm_master_bfm_0_m0_translator -L custom_module_0 -L mm_slave_bfm_0 -L mm_master_bfm_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
