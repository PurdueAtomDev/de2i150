...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_pcie_hard_ip_0_altgx_internal.vo"        -work altgx_internal                                                         -cdslib ./cds_libs/altgx_internal.cds.lib                                                        
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_irq_mapper.sv"                           -work irq_mapper                                                             -cdslib ./cds_libs/irq_mapper.cds.lib                                                            
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_mux.sv"                         -work rsp_xbar_mux                                                           -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_demux.sv"                       -work rsp_xbar_demux                                                         -cdslib ./cds_libs/rsp_xbar_demux.cds.lib                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_xbar_mux                                                           -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_mux.sv"                         -work cmd_xbar_mux                                                           -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux_001.sv"                   -work cmd_xbar_demux_001                                                     -cdslib ./cds_libs/cmd_xbar_demux_001.cds.lib                                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux.sv"                       -work cmd_xbar_demux                                                         -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                        
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_id_router.sv"                            -work id_router                                                              -cdslib ./cds_libs/id_router.cds.lib                                                             
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_addr_router_002.sv"                      -work addr_router_002                                                        -cdslib ./cds_libs/addr_router_002.cds.lib                                                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_addr_router.sv"                          -work addr_router                                                            -cdslib ./cds_libs/addr_router.cds.lib                                                           
  ncvlog     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                 -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -cdslib ./cds_libs/sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.cds.lib
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                            -work sdram_controller_s1_translator_avalon_universal_slave_0_agent          -cdslib ./cds_libs/sdram_controller_s1_translator_avalon_universal_slave_0_agent.cds.lib         
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                     -work sdram_controller_s1_translator_avalon_universal_slave_0_agent          -cdslib ./cds_libs/sdram_controller_s1_translator_avalon_universal_slave_0_agent.cds.lib         
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                           -work write_master_avalon_master_translator_avalon_universal_master_0_agent  -cdslib ./cds_libs/write_master_avalon_master_translator_avalon_universal_master_0_agent.cds.lib 
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                       -work sdram_controller_s1_translator                                         -cdslib ./cds_libs/sdram_controller_s1_translator.cds.lib                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                      -work write_master_avalon_master_translator                                  -cdslib ./cds_libs/write_master_avalon_master_translator.cds.lib                                 
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_pcie_hard_ip_0.v"                        -work pcie_hard_ip_0                                                         -cdslib ./cds_libs/pcie_hard_ip_0.cds.lib                                                        
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_reconf_registers.v"                      -work reconf_registers                                                       -cdslib ./cds_libs/reconf_registers.cds.lib                                                      
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_sdram_controller.v"                      -work sdram_controller                                                       -cdslib ./cds_libs/sdram_controller.cds.lib                                                      
  ncvlog     "$QSYS_SIMDIR/amm_master_qsys.v"                                                                                                                                                                                                                                
fi
