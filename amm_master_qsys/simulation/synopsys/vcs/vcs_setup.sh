...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_pcie_hard_ip_0_altgx_internal.vo \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_irq_mapper.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_id_router.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_addr_router_002.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_addr_router.sv \
  $QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_pcie_hard_ip_0.v \
  $QSYS_SIMDIR/submodules/amm_master_qsys_reconf_registers.v \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_sdram_controller.v \
  $QSYS_SIMDIR/amm_master_qsys.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
