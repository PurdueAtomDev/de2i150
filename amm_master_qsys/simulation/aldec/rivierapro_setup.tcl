...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_irq_mapper.sv"                    -work irq_mapper                                                            
  ...
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_mux.sv"                  -work rsp_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_rsp_xbar_demux.sv"                -work rsp_xbar_demux                                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                      -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_mux.sv"                  -work cmd_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux_001.sv"            -work cmd_xbar_demux_001                                                    
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_cmd_xbar_demux.sv"                -work cmd_xbar_demux                                                        
  ...
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_id_router.sv"                     -work id_router                                                             
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_addr_router_002.sv"               -work addr_router_002                                                       
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_addr_router.sv"                   -work addr_router                                                           
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                     -work sdram_controller_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"              -work sdram_controller_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                    -work write_master_avalon_master_translator_avalon_universal_master_0_agent 
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                -work sdram_controller_s1_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"               -work write_master_avalon_master_translator                                 
