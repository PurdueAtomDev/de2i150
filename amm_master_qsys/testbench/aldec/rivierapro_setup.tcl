...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/amm_master_qsys_irq_mapper.sv"                    -work irq_mapper                                                            
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                 -work crosser                                                               
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_width_adapter.sv"                   -work width_adapter                                                         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_address_alignment.sv"               -work width_adapter                                                         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"              -work width_adapter                                                         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_arbitrator.sv"                      -work rsp_xbar_mux                                                          
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/amm_master_qsys_rsp_xbar_mux.sv"                  -work rsp_xbar_mux                                                          
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/amm_master_qsys_cmd_xbar_demux_001.sv"            -work cmd_xbar_demux_001                                                    
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_burst_adapter.sv"                   -work burst_adapter                                                         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_address_alignment.sv"               -work burst_adapter                                                         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                 -work limiter                                                               
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                 -work limiter                                                               
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/amm_master_qsys_id_router.sv"                     -work id_router                                                             
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/amm_master_qsys_addr_router_002.sv"               -work addr_router_002                                                       
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_slave_agent.sv"                     -work sdram_controller_s1_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"              -work sdram_controller_s1_translator_avalon_universal_slave_0_agent         
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv"                -work sdram_controller_s1_translator                                        
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L irq_mapper -L crosser -L width_adapter -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router -L addr_router_002 -L addr_router -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L sdram_controller_s1_translator_avalon_universal_slave_0_agent -L write_master_avalon_master_translator_avalon_universal_master_0_agent -L sdram_controller_s1_translator -L write_master_avalon_master_translator -L pcie_hard_ip_0 -L reconf_registers -L write_master -L sdram_controller -L pcie_hard_ip_0_pcie_bfm_0 -L amm_master_qsys_inst_reset_bfm -L amm_master_qsys_inst_clk_bfm -L amm_master_qsys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L irq_mapper -L crosser -L width_adapter -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router -L addr_router_002 -L addr_router -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L sdram_controller_s1_translator_avalon_universal_slave_0_agent -L write_master_avalon_master_translator_avalon_universal_master_0_agent -L sdram_controller_s1_translator -L write_master_avalon_master_translator -L pcie_hard_ip_0 -L reconf_registers -L write_master -L sdram_controller -L pcie_hard_ip_0_pcie_bfm_0 -L amm_master_qsys_inst_reset_bfm -L amm_master_qsys_inst_clk_bfm -L amm_master_qsys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
