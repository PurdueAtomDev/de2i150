...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_slave_agent.sv"                                           -work new_sdram_controller_0_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                                    -work new_sdram_controller_0_s1_translator_avalon_universal_slave_0_agent         
  ...
  vlog -sv "$QSYS_SIMDIR/amm_master_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv"                                      -work new_sdram_controller_0_s1_translator                                        
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_avalon_vip_pkgs_lib -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L new_sdram_controller_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L new_sdram_controller_0_s1_translator_avalon_universal_slave_0_agent -L write_master_avalon_master_translator_avalon_universal_master_0_agent -L new_sdram_controller_0_s1_translator -L write_master_avalon_master_translator -L write_master -L new_sdram_controller_0 -L amm_master_qsys_inst_reset_bfm -L amm_master_qsys_inst_clk_bfm -L amm_master_qsys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
