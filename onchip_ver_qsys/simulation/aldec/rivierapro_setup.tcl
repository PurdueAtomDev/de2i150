...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "onchip_ver_qsys"
} 
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/onchip_ver_qsys_onchip_memory2_0.hex ./
}
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"  -work onchip_memory2_0_s1_translator      
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work read_master_avalon_master_translator
  vlog  "$QSYS_SIMDIR/submodules/onchip_ver_qsys_onchip_memory2_0.v" -work onchip_memory2_0                    
  ...
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys.v"                                                                       
}
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L rst_controller -L onchip_memory2_0_s1_translator -L read_master_avalon_master_translator -L onchip_memory2_0 -L write_master -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
