...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work read_master_avalon_master_translator
  vlogan +v2k           "$QSYS_SIMDIR/submodules/onchip_ver_qsys_onchip_memory2_0.v" -work onchip_memory2_0                    
  ...
  vlogan +v2k           "$QSYS_SIMDIR/onchip_ver_qsys.v"                                                                       
fi
