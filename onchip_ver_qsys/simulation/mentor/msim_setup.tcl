...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work read_master_avalon_master_translator
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L rst_controller -L onchip_memory2_0_s1_translator -L read_master_avalon_master_translator -L onchip_memory2_0 -L write_master -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L rst_controller -L onchip_memory2_0_s1_translator -L read_master_avalon_master_translator -L onchip_memory2_0 -L write_master -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
