...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv"  -work onchip_memory2_0_s1_translator      
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/altera_merlin_master_translator.sv" -work read_master_avalon_master_translator
  ...
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/verbosity_pkg.sv"                   -work onchip_ver_qsys_inst_reset_bfm      
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/altera_avalon_reset_source.sv"      -work onchip_ver_qsys_inst_reset_bfm      
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/verbosity_pkg.sv"                   -work onchip_ver_qsys_inst_clk_bfm        
  vlog  "$QSYS_SIMDIR/onchip_ver_qsys_tb/simulation/submodules/altera_avalon_clock_source.sv"      -work onchip_ver_qsys_inst_clk_bfm        
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L rst_controller -L onchip_memory2_0_s1_translator -L read_master_avalon_master_translator -L onchip_memory2_0 -L write_master -L onchip_ver_qsys_inst_reset_bfm -L onchip_ver_qsys_inst_clk_bfm -L onchip_ver_qsys_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
