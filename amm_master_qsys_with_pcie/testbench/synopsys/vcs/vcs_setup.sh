...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/amm_master_qsys_with_pcie_tb/simulation/submodules/altera_avalon_dc_fifo.v \
  $QSYS_SIMDIR/amm_master_qsys_with_pcie_tb/simulation/submodules/altera_dcfifo_synchronizer_bundle.v \
