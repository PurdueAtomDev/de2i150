...
# ACDS 13.0sp1 232 linux 2014.11.18.14:06:37
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.hex ./
}
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_005.sv"       -work rsp_xbar_mux_005                                            
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work rsp_xbar_mux_003                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_003.sv"       -work rsp_xbar_mux_003                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_004.sv"     -work rsp_xbar_demux_004                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_003.sv"     -work rsp_xbar_demux_003                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_002.sv"     -work rsp_xbar_demux_002                                          
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_004                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_004.sv"       -work cmd_xbar_mux_004                                            
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_003                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_003.sv"       -work cmd_xbar_mux_003                                            
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_002                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_002.sv"       -work cmd_xbar_mux_002                                            
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_007.sv"     -work cmd_xbar_demux_007                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_006.sv"     -work cmd_xbar_demux_006                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_005.sv"     -work cmd_xbar_demux_005                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_004.sv"     -work cmd_xbar_demux_004                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_003.sv"     -work cmd_xbar_demux_003                                          
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                          
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work rsp_xbar_mux                                                
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux.sv"           -work rsp_xbar_mux                                                
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux.sv"         -work rsp_xbar_demux                                              
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                              
  ...
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_004.sv"          -work id_router_004                                               
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_003.sv"          -work id_router_003                                               
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_002.sv"          -work id_router_002                                               
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_006.sv"        -work addr_router_006                                             
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_005.sv"        -work addr_router_005                                             
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_003.sv"        -work addr_router_003                                             
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_001.sv"        -work addr_router_001                                             
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router.sv"              -work id_router                                                   
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router.sv"            -work addr_router                                                 
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                             -work sgdma_csr_translator_avalon_universal_slave_0_agent_rsp_fifo
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                        -work sgdma_csr_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                 -work sgdma_csr_translator_avalon_universal_slave_0_agent         
  ...
  vlog  "$QSYS_SIMDIR/submodules/custom_master.v"                                     -work read_master                                                 
  vlog  "$QSYS_SIMDIR/submodules/burst_write_master.v"                                -work read_master                                                 
  vlog  "$QSYS_SIMDIR/submodules/burst_read_master.v"                                 -work read_master                                                 
  vlog  "$QSYS_SIMDIR/submodules/write_master.v"                                      -work read_master                                                 
  vlog  "$QSYS_SIMDIR/submodules/latency_aware_read_master.v"                         -work read_master                                                 
  vlog  "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.v"        -work reconf_registers                                            
