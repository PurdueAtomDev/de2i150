...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_005.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_003.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_004.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_004.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_007.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_006.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_005.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.v \
