...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_avalon_dc_fifo.v"                                  -work async_fifo                                                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_dcfifo_synchronizer_bundle.v"                      -work async_fifo                                                  
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_005.sv"            -work rsp_xbar_mux_005                                            
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_004.sv"          -work rsp_xbar_demux_004                                          
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_004.sv"            -work cmd_xbar_mux_004                                            
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_007.sv"          -work cmd_xbar_demux_007                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_006.sv"          -work cmd_xbar_demux_006                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_005.sv"          -work cmd_xbar_demux_005                                          
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/custom_master.v"                                          -work read_master                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/burst_write_master.v"                                     -work read_master                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/burst_read_master.v"                                      -work read_master                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/write_master.v"                                           -work read_master                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/latency_aware_read_master.v"                              -work read_master                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.v"             -work reconf_registers                                            
