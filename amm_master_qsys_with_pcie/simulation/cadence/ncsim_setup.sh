...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/altera_avalon_dc_fifo.v"                                 -work async_fifo                                                   -cdslib ./cds_libs/async_fifo.cds.lib                                                  
  ncvlog     "$QSYS_SIMDIR/submodules/altera_dcfifo_synchronizer_bundle.v"                     -work async_fifo                                                   -cdslib ./cds_libs/async_fifo.cds.lib                                                  
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_005.sv"           -work rsp_xbar_mux_005                                             -cdslib ./cds_libs/rsp_xbar_mux_005.cds.lib                                            
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_004.sv"         -work rsp_xbar_demux_004                                           -cdslib ./cds_libs/rsp_xbar_demux_004.cds.lib                                          
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_004.sv"           -work cmd_xbar_mux_004                                             -cdslib ./cds_libs/cmd_xbar_mux_004.cds.lib                                            
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_007.sv"         -work cmd_xbar_demux_007                                           -cdslib ./cds_libs/cmd_xbar_demux_007.cds.lib                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_006.sv"         -work cmd_xbar_demux_006                                           -cdslib ./cds_libs/cmd_xbar_demux_006.cds.lib                                          
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_006.sv"            -work addr_router_006                                              -cdslib ./cds_libs/addr_router_006.cds.lib                                             
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/custom_master.v"                                         -work read_master                                                  -cdslib ./cds_libs/read_master.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/burst_write_master.v"                                    -work read_master                                                  -cdslib ./cds_libs/read_master.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/burst_read_master.v"                                     -work read_master                                                  -cdslib ./cds_libs/read_master.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/write_master.v"                                          -work read_master                                                  -cdslib ./cds_libs/read_master.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/latency_aware_read_master.v"                             -work read_master                                                  -cdslib ./cds_libs/read_master.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_reconf_registers.v"            -work reconf_registers                                             -cdslib ./cds_libs/reconf_registers.cds.lib                                            
