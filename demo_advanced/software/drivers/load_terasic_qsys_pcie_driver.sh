...
#richard DRV_NAME="alt_up_pci"
DRV_NAME="terasic_qsys_pcie"
# The default name of the configuration file.
#richard CONFIG_FILE="config_file"
CONFIG_FILE="de2i_150_config_file"
...
if [ -n "$DRV_MAJOR" ]; then
	...
	sudo ./unload_terasic_qsys_pcie_driver.sh
	exit 1
fi
