...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/arit.sv"                                                      -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/controlunit.sv"                                               -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/flex_counter.sv"                                              -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/ImageSpecRegs.sv"                                             -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/memory_cntrl.sv"                                              -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/outputlogic.sv"                                               -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/readCounter.sv"                                               -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/shift_register.sv"                                            -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/startdecoder.sv"                                              -work user_module_0              
  vlog -sv "$QSYS_SIMDIR/submodules/top_levelu.sv"                                                -work user_module_0              
