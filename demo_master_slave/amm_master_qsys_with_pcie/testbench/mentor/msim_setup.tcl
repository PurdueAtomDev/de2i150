...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/amm_master_qsys_with_pcie_tb/simulation/submodules/custom_slave.sv"                                                                      -work custom_module                                               
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_avalon_vip_pkgs_lib -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L irq_mapper -L crosser -L width_adapter -L cmd_xbar_demux_006 -L rsp_xbar_mux_003 -L rsp_xbar_demux_003 -L rsp_xbar_demux_002 -L cmd_xbar_mux_003 -L cmd_xbar_mux_002 -L cmd_xbar_demux_004 -L cmd_xbar_demux_003 -L cmd_xbar_demux_001 -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_004 -L addr_router_006 -L id_router_003 -L id_router_002 -L addr_router_005 -L addr_router_003 -L addr_router_001 -L id_router -L addr_router -L sgdma_csr_translator_avalon_universal_slave_0_agent_rsp_fifo -L sgdma_csr_translator_avalon_universal_slave_0_agent -L pcie_ip_bar2_translator_avalon_universal_master_0_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L custom_module -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L pcie_ip_pcie_bfm_0 -L amm_master_qsys_with_pcie_inst_reset_bfm -L amm_master_qsys_with_pcie_inst_clk_bfm -L amm_master_qsys_with_pcie_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
