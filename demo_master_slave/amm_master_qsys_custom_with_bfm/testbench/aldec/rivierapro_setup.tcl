...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/amm_master_qsys_custom_with_bfm_tb/simulation/submodules/altera_merlin_slave_translator.sv"  -work mm_slave_bfm_0_s0_translator                  
  vlog  "$QSYS_SIMDIR/amm_master_qsys_custom_with_bfm_tb/simulation/submodules/altera_merlin_master_translator.sv" -work custom_module_0_avalon_master_translator      
  vlog  "$QSYS_SIMDIR/amm_master_qsys_custom_with_bfm_tb/simulation/submodules/custom_slave.sv"                    -work custom_module_0                               
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L rst_controller -L mm_slave_bfm_0_s0_translator -L custom_module_0_avalon_master_translator -L custom_module_0 -L mm_slave_bfm_0 -L mm_master_bfm_0 -L amm_master_qsys_custom_with_bfm_inst_reset_bfm -L amm_master_qsys_custom_with_bfm_inst_clk_bfm -L amm_master_qsys_custom_with_bfm_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
