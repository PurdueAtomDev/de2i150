...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"  -work mm_slave_bfm_0_s0_translator            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work custom_module_0_avalon_master_translator
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/custom_slave.sv"                    -work custom_module_0                         
