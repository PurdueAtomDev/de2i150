...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_005.sv"        -work cmd_xbar_demux_005                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work rsp_xbar_mux_003                                            
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux_003.sv"          -work rsp_xbar_mux_003                                            
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_003.sv"        -work rsp_xbar_demux_003                                          
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux_002.sv"        -work rsp_xbar_demux_002                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_xbar_mux_003                                            
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_003.sv"          -work cmd_xbar_mux_003                                            
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work cmd_xbar_mux_002                                            
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_mux_002.sv"          -work cmd_xbar_mux_002                                            
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_004.sv"        -work cmd_xbar_demux_004                                          
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_003.sv"        -work cmd_xbar_demux_003                                          
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux_001.sv"        -work cmd_xbar_demux_001                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                            -work rsp_xbar_mux                                                
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_mux.sv"              -work rsp_xbar_mux                                                
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_rsp_xbar_demux.sv"            -work rsp_xbar_demux                                              
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_cmd_xbar_demux.sv"            -work cmd_xbar_demux                                              
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_004.sv"             -work id_router_004                                               
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_005.sv"           -work addr_router_005                                             
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_003.sv"             -work id_router_003                                               
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router_002.sv"             -work id_router_002                                               
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_003.sv"           -work addr_router_003                                             
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router_001.sv"           -work addr_router_001                                             
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_id_router.sv"                 -work id_router                                                   
  vlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_addr_router.sv"               -work addr_router                                                 
  vlog     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                -work sgdma_csr_translator_avalon_universal_slave_0_agent_rsp_fifo
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                           -work sgdma_csr_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                    -work sgdma_csr_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                          -work pcie_ip_bar2_translator_avalon_universal_master_0_agent     
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/custom_slave.sv"                                        -work custom_slave_block_0                                        
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L irq_mapper -L crosser -L width_adapter -L cmd_xbar_demux_005 -L rsp_xbar_mux_003 -L rsp_xbar_demux_003 -L rsp_xbar_demux_002 -L cmd_xbar_mux_003 -L cmd_xbar_mux_002 -L cmd_xbar_demux_004 -L cmd_xbar_demux_003 -L cmd_xbar_demux_001 -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_004 -L addr_router_005 -L id_router_003 -L id_router_002 -L addr_router_003 -L addr_router_001 -L id_router -L addr_router -L sgdma_csr_translator_avalon_universal_slave_0_agent_rsp_fifo -L sgdma_csr_translator_avalon_universal_slave_0_agent -L pcie_ip_bar2_translator_avalon_universal_master_0_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L custom_slave_block_0 -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
