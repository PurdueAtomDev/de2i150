...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/amm_master_qsys_with_pcie_tb/simulation/submodules/custom_slave.sv"                                         -work custom_slave_block_0                                         -cdslib ./cds_libs/custom_slave_block_0.cds.lib                                        
